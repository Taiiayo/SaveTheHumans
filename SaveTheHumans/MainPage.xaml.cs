...
namespace SaveTheHumans
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void Button_Click(object sender, RoutedEventArgs e)
        {
            ...
            MessageDialog mes = new MessageDialog("Save the Humans! These are the last of those who can be saved. To save them, you need to use the Green Gates" +
                " - a portal to a new Galaxy. Pick a human and move him slowly to the Green Gates. Avoid aliens and try to be as fast as you can.");
            await mes.ShowAsync();
